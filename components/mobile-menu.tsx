        ...
        {isOpen && (
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-end space-y-3 antialiased font-[600] text-[2.5rem] text-gray-500 px-8 mt-4">
              ...
              <div className="mt-4 px-8 pb-8 pt-28">
                <div className="flex flex-wrap justify-end gap-x-6 gap-y-2 text-gray-500 text-sm mb-4">
                  ...
                  <Link href="/status" className="hover:text-gray-700">Status page</Link>
                  <Link href="/privacy" className="hover:text-gray-700">Privacy & Security</Link>
                ...
                <div className="flex flex-col items-end space-y-1 text-gray-500 text-sm mt-4">
                  ...
                  <Link href="/press" className="hover:text-gray-700">Press kit</Link>
                  <Link href="/license" className="hover:text-gray-700">License</Link>
                </div>
              </div>
            </motion.div>
          </motion.div>
